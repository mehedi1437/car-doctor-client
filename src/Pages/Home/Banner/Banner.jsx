  ...
  return (
    <div className="carousel w-full h-[600px]">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        <div className="absolute rounded-xl flex items-center pl-12  h-full w-full   bg-gradient-to-r from-black to-[rgba(21,21,21,0)]  ">
          <div
            className="text-white space-y-7 w-1/2 
          "
          >
            <h2 className="text-4xl font-bold">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos
              excepturi quo reiciendis distinctio 
            </h2>
            <p>
