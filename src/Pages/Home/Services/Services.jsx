  ...
  return (
    <div className="mt-10">
      <div className="text-center space-y-5">
        <h3 className="text-2xl font-bold text-center text-[#fe552b]">Our Services</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-6">
        {
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-start">
                <button className="btn bg-[#fe552b] text-xl text-white "> <Link to={`/cheakout/${service._id}`}><HiArrowNarrowRight /></Link> </button>
              </div>
            </div>
          </div>)
        }
